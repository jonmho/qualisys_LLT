...
file = fd.askopenfilename(title='Rasterdatei auswählen',initialdir='D:\\FH Aachen\\Lernen\\Abschlussarbeiten\\Praxisprojekt\\Endergebnisse\\',multiple=False,filetypes=(('raster_1_4_8000', '*.txt'), ('All files', '*.*')))
...
file_2 = "D:\\FH Aachen\\Lernen\\Abschlussarbeiten\\Praxisprojekt\\Endergebnisse\\gcode\\raster_1_4_8000.txt"
...
file_3_all = fd.askopenfilename(title='Qualisys-Daten auswählen',initialdir='D:\\FH Aachen\\Lernen\\Abschlussarbeiten\\Praxisprojekt\\Endergebnisse\\',multiple=True,filetypes=(('Rasterdatei', '*.txt'), ('All files', '*.*')))
print("Qualisys file: ", file_3_all)
...
for file_3 in file_3_all:
    head,tail = os.path.split(file_3)
    #qualisys daten bahn
    ...
    #verzerrt_name = head[:-4] + "_verzerrt.txt"
    verzerrt_name = os.path.join(head[:-8] + "/helmert_projection", tail[:-4] + "_verzerrt.txt")
