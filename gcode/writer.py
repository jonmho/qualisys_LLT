...
folder = "C:\\Users\\LAPTOP845_LGORISSEN\\Documents\\Qualisys\\python_neu\\\cnc_gcode\\"
...
if art == 's':
    with open(dname , 'w') as f:
        counter = 50
        ende = 4
        f.write("%{} ({} {})\n".format(name,counter,ende))
        f.write("N0010 G28.1\n")
        f.write("N0020 G90 G1 F6000 X611 Y1222 Z{}\n".format(hoehe))
        f.write("N0030 G1 F{}\n".format(geschw))
        f.write("N0040 G04 P3000\n")
...
#ebene_x
    ...
    with open(dname , 'w') as f:
        ...
        f.write("%{} ({} {})\n".format(name,counter,ende))
        f.write("N0010 G28.1\n")
        f.write("N0020 G90 G1 F6000 X0 Y0 Z{}\n".format(hoehe))
        f.write("N0030 G1 F{}\n".format(geschw))
        f.write("N0040 G04 P3000\n")
