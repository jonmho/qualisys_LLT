...
for _ in range(3):
    ...
    filelist = fd.askopenfilename(title='Qualisys-Daten auswählen',initialdir='D:\\FH Aachen\\Lernen\\Abschlussarbeiten\\Praxisprojekt\\Endergebnisse\\',multiple=True,filetypes=(('Ergebnissdateien', '*.txt'), ('All files', '*.*')))
...
'''
fig, ax = plt.subplots()
erg = ax.boxplot(bxlist2, notch=None,labels=["2 m/min","6 m/min","10 m/min"])
